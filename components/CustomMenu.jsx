	...
	return (
		<View>
			<Modal
				...
				<View className="w-[100%]   bg-[#2b2b2b70] h-full items-end  ">
					<View className="bg-white h-full w-[80%] pt-[80px] rounded-l-[30px] ">
						<View
						...
						<View className="mt-[40px]">
							<MainButton
								icon={icons.SignOut}
								iconStyles={"mr-2"}
								containerStyles={"m-auto mt-[100px] w-[200px] min-h-[50px]    "}
